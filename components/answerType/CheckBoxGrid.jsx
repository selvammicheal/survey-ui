...
const CheckBoxGrid = ({question, sectionIndex, questionIndex, formInfo, setFormInfo}) => {
                    ...
                    question?.question_data?.rowData.map((item, index) => (
                        ...
                        <div className="row mt-2" key={index}>
                            ...
                            <div className='d-flex align-items-center'>
                                ...
                                <div className='w-100'>
                                    <input type="text" name="name" value={item.name} onChange={(e) => updateRow(e.target.value, index)} className='text-light-color questionType' />
                                </div>
                                {
                    ...
                    question?.question_data?.colData.map((item, index) => (
                        <div className="row mt-2" key={index}>
                            <div className='d-flex align-items-center'>
                                ...
                                <div className="w-100">
                                    <input type="text" name="name" onChange={(e) => updateCol(e.target.value, index)} value={item.name} className='text-light-color questionType' />
                                </div>
                                {
